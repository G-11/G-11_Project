...
//クラス定義
class CCircleGage :public Sprite
{
public:
	CCircleGage(int priority = Sprite::LAYER_INTERFACE);
	~CCircleGage();

	static CCircleGage* Create(const D3DXVECTOR3& pos,float r,int divide,bool point = true,int priority = Sprite::LAYER_INTERFACE);
